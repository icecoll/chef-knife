execute "yum -y install epel-release"
  ...
  bash "yum groupinstall Development Libraries" do
    ...
    code <<-EOC
      ...
      yum install -y sysstat mosh wget telnet nc patch make git openssl-devel readline-devel zlib-devel mailx man dstat iotop iptraf hdparm socat iptables-services fail2ban sudo
    EOC
